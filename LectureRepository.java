...
public class LectureRepository extends FileRepository<Lecture> {
    ...
    public void init() {
        ...
        initialLectures.add(new Lecture(1, "Introduction to Programming", "Dr. John Smith", "Monday", "09:00", 90, "Building A, Room 101", "Introduction to programming concepts"));
        initialLectures.add(new Lecture(2, "Data Structures", "Prof. Jane Doe", "Tuesday", "11:00", 120, "Building B, Room 205", "Arrays and linked lists"));
        initialLectures.add(new Lecture(3, "Introduction to Programming", "Dr. John Smith", "Wednesday", "14:00", 60, "Building C, Room 310", "Control structures"));
        initialLectures.add(new Lecture(4, "Data Structures", "Prof. Jane Doe", "Thursday", "10:00", 90, "Building A, Room 102", "Sorting algorithms"));
